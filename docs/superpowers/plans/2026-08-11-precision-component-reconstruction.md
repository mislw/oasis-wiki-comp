...
- [ ] **Step 1: Write failing tests** for reusable target consolidation, native bitmap rejection, unsafe skin rejection, one job per target, inactive-only statuses, and bundled-file presence.
- [ ] **Step 2: Run the tests** and verify they fail because the Cowart scripts and assets do not exist.
...
- [ ] **Step 1: Implement minimal plan grouping** by `target_component_id`.
- [ ] **Step 2: Implement plan validation** for source metadata, modes, statuses, outputs, bounds, and reconstruction constraints.
- [ ] **Step 3: Re-run Python tests** and confirm the covered validations pass.
...
- [ ] **Step 1: Generate one job per reusable target** without performing image generation.
- [ ] **Step 2: Add deterministic preview composition and alpha-aware reconstruction validation.**
- [ ] **Step 3: Run the Python suite** and confirm every workflow boundary passes.
...
- [ ] **Step 1: Document Stage 2A and Stage 2B** with native boundaries, multi-instance grouping, nine-slice assessment, and review gates.
- [ ] **Step 2: Link the guide from both portable entry points.**
- [ ] **Step 3: Run Node presence checks and Skill hygiene validation.**

### Task 5: Verify and publish

**Files:** Git history and bundled Skill resources.

- [ ] **Step 1: Run Python, Node, hygiene, application build, and Rust checks where dependencies permit.**
- [ ] **Step 2: Inspect the diff** for scope and generated artifacts.
