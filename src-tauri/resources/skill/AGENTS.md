...
- For natural-language UI generation requests, immediately run `scripts/cowart-ui/component-extractor/open_ui_workflow.py` to open or focus Companion's native UI generation workflow, then continue SOURCE in the current conversation.
